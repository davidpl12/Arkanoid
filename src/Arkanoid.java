...
//			for (Actor p : actores) {
//				// Evito comparar un actor consigo mismo, ya que eso siempre provocará una colisión y no tiene sentido
//				if (!actor1.equals(p)) {
//					// Formo el rectangulo de la pelota
//					Rectangle rect2 = new Rectangle(p.getX(), p.getY(), p.getAncho(), p.getAlto());
//					// Si los dos rectÃ¡ngulos tienen alguna intersecciÃ³n, notifico una colisión en los dos actores
